from resources.ip import free5gcIP, free5gcPort
commands = [
    'ps-establish',
    'ps-list',
    'ps-release',
...
headers = {
    ...
    "Token": "admin",
    "Origin": "http://"+ free5gcIP +":" + free5gcPort,
    "Connection": "keep-alive",
    "Referer": "http://"+ free5gcIP +":" + free5gcPort
}

url = "http://"+ free5gcIP +":"+ free5gcPort + "/api/subscriber/"
